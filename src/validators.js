  ...
  R.curry(
    (keys, props) => {
      return Maybe(
        ...
        .chain(keysMissing => keysMissing.length === 0 ? Right(props) : Left({ ...props, errors: { missingKeys: keysMissing }}))
    }
  )
  ...
  R.curry(
    (validations, props) => {
      return Maybe(
        ...
        .chain(invalidValues => invalidValues.length === 0 ? Right(props) : Left({...props, errors:{ notValidValues: invalidValues }}))
    }
  )
