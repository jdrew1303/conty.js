  ...
  R.curry(
    (keys, props) => {
      return Maybe(
        ...
        .chain(keysMissing => keysMissing.length === 0 ? Right(props) : Left({ ...props, errors: [...props.errors, { type: 'missingKeys', values: keysMissing }]}))
    }
  )
  ...
  R.curry(
    (validations, props) => {
      return Maybe(
        ...
        .chain(invalidValues => invalidValues.length === 0 ? Right(props) : Left({...props, errors: [...props.errors, { type: 'notValidValues', values: invalidValues }]}))
    }
  )
